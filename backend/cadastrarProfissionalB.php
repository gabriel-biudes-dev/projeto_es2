...
//Validações
if(empty($nome) || empty($estado) || empty($municipio) || empty($logradouro) || empty($bairro) || empty($numero) || empty($raca) || empty($especialidade) || empty($genero) || empty($nascimento)) return;
if($numero == 0) return;
